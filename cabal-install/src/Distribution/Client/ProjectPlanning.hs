          ...
          buildComponent (cc_map, lc_map, exe_map) comp =
            addProgressCtx
              ...
              $ do
                ...
                infoProgress $ hang (text "elaborated component" <+> pretty cname) 4 $ vcat
                  [ text "compLibDependencies:" <+> Disp.hsep (punctuate comma $ map (pretty . fst) compLibDependencies)
                  , text "compExeDependencies:" <+> Disp.hsep (punctuate comma $ map pretty compExeDependencies)
